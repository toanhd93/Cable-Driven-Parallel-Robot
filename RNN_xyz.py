...
# load data
#xy = pd.read_csv("0.00272_Pos_data.txt", delimiter = "	") 
...
model.add(LSTM(units = 32, return_sequences = False, activation = 'tanh', input_shape = (None, seq_length)))
...
history = model.fit(trainX, trainY, batch_size = 16, epochs = 500)
...
#model.save("0.00272_Low_model_N_.h5")
model.save("Model_v2_.h5")
